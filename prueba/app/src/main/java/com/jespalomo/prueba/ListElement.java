...
public class ListElement implements Serializable {
    ...
    public ListElement(String ruta, String duracion, String tipo, String nombre1, String nombre2, Double latVertical1, Double latVertical2, Double latHorizontal1, Double latHorizontal2) {
        this.ruta = ruta;
